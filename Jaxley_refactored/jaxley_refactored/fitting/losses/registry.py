...
def default_loss_registry() -> LossRegistry:
    ...
    registry.register("experimental_voltage_band_mse", primitives.masked_mse)
    ...
    registry.register(
        ...
        primitives.soft_interspike_minimum_voltage_error,
    )
    registry.register(
        "soft_interspike_trough_shape_error",
        primitives.soft_interspike_trough_shape_error,
    )
    registry.register(
