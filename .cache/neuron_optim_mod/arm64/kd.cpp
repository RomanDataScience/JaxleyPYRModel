...
#define deactivation_tau_scale _ml->template fpfield<1>(_iml)
#define deactivation_tau_scale_columnindex 1
...
#define vhalfm vhalfm_kd
 ...
 {"mtau_kd", "ms"},
 {"htau_kd", "ms"},
 {"deactivation_tau_scale_kd", "S/cm2"},
 {"i_kd", "mA/cm2"},
 {0, 0}
};
  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 4, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 10);
 	...
 	deactivation_tau_scale = _parm_default[1]; /* 1 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 10);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"deactivation_tau_scale"} /* 1 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 kd /Users/romanbaravalle/Documents/Consultancy/JaxleyPYRModel/.cache/neuron_optim_mod/kd.mod\n");
...
static int  trates (  double _lv ) {
 ...
 _lqt = pow( q10 , ( ( celsius - 22.0 ) / 10.0 ) ) ;
   ...
   mtau = 0.6 * deactivation_tau_scale ;
   htau = 1500.0 ;
    return 0; }
...
static void _hoc_trates(void) {
  ...
  if(!_prop_id) {
    hoc_execerror("No data for trates_kd. Requires prior call to setdata_kd and that the specified mechanism instance still be in existence.", NULL);
  } else {
 ...
 v=_v;
{
 ...
 { error =  states();
 if(error){
  std_cerr_stream << "at line 45 in file kd.mod:\nBREAKPOINT {\n";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/romanbaravalle/Documents/Consultancy/JaxleyPYRModel/.cache/neuron_optim_mod/kd.mod";
  ...
  "	RANGE gk, gbar, i, deactivation_tau_scale\n"
  "	GLOBAL minf, mtau, hinf, htau\n"
  "}\n"
  "\n"
  "PARAMETER {\n"
  "	gbar = 0.1\n"
  "	deactivation_tau_scale = 1   	(S/cm2)	\n"
  "								\n"
  "	celsius\n"
  "	ek = -100	(mV)          \n"
  "	v 		(mV)\n"
