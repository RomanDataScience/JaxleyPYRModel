...
#define Offset _ml->template fpfield<2>(_iml)
#define Offset_columnindex 2
#define Slope _ml->template fpfield<3>(_iml)
...
#define Dg _ml->template fpfield<6>(_iml)
  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 2, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 9);
 	...
 	ek = _parm_default[1]; /* -95 */
 	Offset = _parm_default[2]; /* 15 */
 	Slope = _parm_default[3]; /* -10 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 9);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _PotassiumInwardRectifier_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("k", -10000.);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"Offset"} /* 2 */,
                                       _nrn_mechanism_field<double>{"Slope"} /* 3 */,
                                       _nrn_mechanism_field<double>{"ik"} /* 4 */,
                                       _nrn_mechanism_field<double>{"g"} /* 5 */,
                                       _nrn_mechanism_field<double>{"Dg"} /* 6 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "k_ion");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 kir /Users/romanbaravalle/Documents/Consultancy/JaxleyPYRModel/.cache/neuron_optim_mod/PotassiumInwardRectifier.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "Simplified KIR (Potassium Inward Rectifier)";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/romanbaravalle/Documents/Consultancy/JaxleyPYRModel/.cache/neuron_optim_mod/PotassiumInwardRectifier.mod";
