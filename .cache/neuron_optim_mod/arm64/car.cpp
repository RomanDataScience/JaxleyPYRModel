...
#define inf _ml->template data_array<2, 2>(_iml)
#define inf_columnindex 2
#define tau _ml->template data_array<3, 2>(_iml)
...
#define cao _ml->template fpfield<7>(_iml)
...
/* Direct Python call wrappers to density mechanism functions.*/
 ...
 static double _npy_varss(Prop*);
 static double _npy_vartau(Prop*);
...
#define vartau vartau_car
 extern double varss( _internalthreadargsprotocomma_ double , double );
 extern double vartau( _internalthreadargsprotocomma_ double , double );
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"inf", 2} /* 2 */,
                                       _nrn_mechanism_field<double>{"tau", 2} /* 3 */,
                                       _nrn_mechanism_field<double>{"m"} /* 4 */,
                                       _nrn_mechanism_field<double>{"h"} /* 5 */,
                                       _nrn_mechanism_field<double>{"cai"} /* 6 */,
                                       _nrn_mechanism_field<double>{"cao"} /* 7 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 car /Users/romanbaravalle/Documents/Consultancy/JaxleyPYRModel/.cache/neuron_optim_mod/car.mod\n");
...
static int _reset;
static const char *modelname = "Ca R-type channel with medium threshold for activation";
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_car. Requires prior call to setdata_car and that the specified mechanism instance still be in existence.", NULL);
  }
...
double varss ( _internalthreadargsprotocomma_ double _lv , double _li ) {
   double _lvarss;
 double _lArg ;
 if ( _li  == 0.0 ) {
     _lArg = ( _lv + 48.5 ) / ( - 3.0 ) ;
...
if (gind != 0 && _thread != nullptr) { _globals = _thread[_gth].get<double*>(); }
_nt = nrn_threads;
 _r =  varss ( _threadargscomma_ *getarg(1) , *getarg(2) );
 hoc_retpushx(_r);
}
 
static double _npy_varss(Prop* _prop) {
    double _r{0.0};
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
 _nrn_mechanism_cache_instance _ml_real{_prop};
auto* const _ml = &_ml_real;
...
double vartau ( _internalthreadargsprotocomma_ double _lv , double _li ) {
   double _lvartau;
 if ( _li  == 0.0 ) {
     _lvartau = 5.0 ;
     }
...
if (gind != 0 && _thread != nullptr) { _globals = _thread[_gth].get<double*>(); }
_nt = nrn_threads;
 _r =  vartau ( _threadargscomma_ *getarg(1) , *getarg(2) );
 hoc_retpushx(_r);
}
 
static double _npy_vartau(Prop* _prop) {
    double _r{0.0};
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
 _nrn_mechanism_cache_instance _ml_real{_prop};
auto* const _ml = &_ml_real;
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/romanbaravalle/Documents/Consultancy/JaxleyPYRModel/.cache/neuron_optim_mod/car.mod";
