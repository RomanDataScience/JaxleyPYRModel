...
#define fast_inactivation_tau_scale _ml->template fpfield<1>(_iml)
#define fast_inactivation_tau_scale_columnindex 1
#define slow_recovery_tau_scale _ml->template fpfield<2>(_iml)
#define slow_recovery_tau_scale_columnindex 2
#define I2init _ml->template fpfield<3>(_iml)
#define I2init_columnindex 3
#define C1O1v2 _ml->template fpfield<4>(_iml)
#define C1O1v2_columnindex 4
#define dist _ml->template fpfield<5>(_iml)
#define dist_columnindex 5
#define slowdown _ml->template fpfield<6>(_iml)
#define slowdown_columnindex 6
#define persist _ml->template fpfield<7>(_iml)
#define persist_columnindex 7
...
#define O1 _ml->template fpfield<11>(_iml)
#define O1_columnindex 11
#define I1 _ml->template fpfield<12>(_iml)
#define I1_columnindex 12
#define I2 _ml->template fpfield<13>(_iml)
#define I2_columnindex 13
#define ena _ml->template fpfield<14>(_iml)
#define ena_columnindex 14
#define C1O1_a _ml->template fpfield<15>(_iml)
#define C1O1_a_columnindex 15
#define O1C1_a _ml->template fpfield<16>(_iml)
#define O1C1_a_columnindex 16
#define O1I1_a _ml->template fpfield<17>(_iml)
#define O1I1_a_columnindex 17
#define I1O1_a _ml->template fpfield<18>(_iml)
#define I1O1_a_columnindex 18
#define I1I2_a _ml->template fpfield<19>(_iml)
#define I1I2_a_columnindex 19
#define I2I1_a _ml->template fpfield<20>(_iml)
#define I2I1_a_columnindex 20
#define I1C1_a _ml->template fpfield<21>(_iml)
#define I1C1_a_columnindex 21
#define C1I1_a _ml->template fpfield<22>(_iml)
#define C1I1_a_columnindex 22
#define Q10 _ml->template fpfield<23>(_iml)
#define Q10_columnindex 23
#define DC1 _ml->template fpfield<24>(_iml)
...
#define O1C1b1 O1C1b1_na16a
 ...
 {"slow_recovery_tau_scale_na16a", "mho/cm2"},
 {"ina_na16a", "mA/cm2"},
 {"g_na16a", "mho/cm2"},
 {0, 0}
};
...
"na16a",
 "gbar_na16a",
 "fast_inactivation_tau_scale_na16a",
 "slow_recovery_tau_scale_na16a",
 "I2init_na16a",
 "C1O1v2_na16a",
 "dist_na16a",
 "slowdown_na16a",
  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 4, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 30);
 	...
 	fast_inactivation_tau_scale = _parm_default[1]; /* 1 */
 	slow_recovery_tau_scale = _parm_default[2]; /* 1 */
 	I2init = _parm_default[3]; /* 0 */
 	C1O1v2 = _parm_default[4]; /* 0 */
 	dist = _parm_default[5]; /* 0 */
 	slowdown = _parm_default[6]; /* 0.2 */
 	persist = _parm_default[7]; /* 0 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 30);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"fast_inactivation_tau_scale"} /* 1 */,
                                       _nrn_mechanism_field<double>{"slow_recovery_tau_scale"} /* 2 */,
                                       _nrn_mechanism_field<double>{"I2init"} /* 3 */,
                                       _nrn_mechanism_field<double>{"C1O1v2"} /* 4 */,
                                       _nrn_mechanism_field<double>{"dist"} /* 5 */,
                                       _nrn_mechanism_field<double>{"slowdown"} /* 6 */,
                                       _nrn_mechanism_field<double>{"persist"} /* 7 */,
                                       _nrn_mechanism_field<double>{"ina"} /* 8 */,
                                       _nrn_mechanism_field<double>{"g"} /* 9 */,
                                       _nrn_mechanism_field<double>{"C1"} /* 10 */,
                                       _nrn_mechanism_field<double>{"O1"} /* 11 */,
                                       _nrn_mechanism_field<double>{"I1"} /* 12 */,
                                       _nrn_mechanism_field<double>{"I2"} /* 13 */,
                                       _nrn_mechanism_field<double>{"ena"} /* 14 */,
                                       _nrn_mechanism_field<double>{"C1O1_a"} /* 15 */,
                                       _nrn_mechanism_field<double>{"O1C1_a"} /* 16 */,
                                       _nrn_mechanism_field<double>{"O1I1_a"} /* 17 */,
                                       _nrn_mechanism_field<double>{"I1O1_a"} /* 18 */,
                                       _nrn_mechanism_field<double>{"I1I2_a"} /* 19 */,
                                       _nrn_mechanism_field<double>{"I2I1_a"} /* 20 */,
                                       _nrn_mechanism_field<double>{"I1C1_a"} /* 21 */,
                                       _nrn_mechanism_field<double>{"C1I1_a"} /* 22 */,
                                       _nrn_mechanism_field<double>{"Q10"} /* 23 */,
                                       _nrn_mechanism_field<double>{"DC1"} /* 24 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 na16a /Users/romanbaravalle/Documents/Consultancy/JaxleyPYRModel/.cache/neuron_optim_mod/Nav16_a.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "Nav1.6 ionic voltage-gated channel with kinetic scheme";
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_na16a. Requires prior call to setdata_na16a and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/romanbaravalle/Documents/Consultancy/JaxleyPYRModel/.cache/neuron_optim_mod/Nav16_a.mod";
  ...
  "	RANGE gbar, ina, g, dist, persist, slowdown, C1O1v2, I2init, fast_inactivation_tau_scale, slow_recovery_tau_scale\n"
  "}\n"
  "\n"
  "UNITS {\n"
  "	(mA) = (milliamp)\n"
  ...
  "	slow_recovery_tau_scale = 1	 (mho/cm2)\n"
  "	\n"
  "	I2init=0\n"
  "	\n"
  "\n"
