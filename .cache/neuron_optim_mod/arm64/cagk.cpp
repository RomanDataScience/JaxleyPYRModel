...
#define cainit _ml->template fpfield<1>(_iml)
  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 6, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 8);
 	...
 	gkbar = _parm_default[0]; /* 0.01 */
 	cainit = _parm_default[1]; /* 0.0001 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 8);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"cainit"} /* 1 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 mykca /Users/romanbaravalle/Documents/Consultancy/JaxleyPYRModel/.cache/neuron_optim_mod/cagk.mod\n");
 ...
 v=_v;
{
 ...
 { error =  state();
 if(error){
  std_cerr_stream << "at line 73 in file cagk.mod:\nBREAKPOINT {\n";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/romanbaravalle/Documents/Consultancy/JaxleyPYRModel/.cache/neuron_optim_mod/cagk.mod";
