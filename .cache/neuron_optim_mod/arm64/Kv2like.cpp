...
#define h1 _ml->template fpfield<4>(_iml)
...
#define h1Tau _ml->template fpfield<12>(_iml)
#define h1Tau_columnindex 12
#define h2Tau _ml->template fpfield<13>(_iml)
#define h2Tau_columnindex 13
#define Dm _ml->template fpfield<14>(_iml)
#define Dm_columnindex 14
#define Dh1 _ml->template fpfield<15>(_iml)
#define Dh1_columnindex 15
#define Dh2 _ml->template fpfield<16>(_iml)
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"h1"} /* 4 */,
                                       ...
                                       _nrn_mechanism_field<double>{"h1Tau"} /* 12 */,
                                       _nrn_mechanism_field<double>{"h2Tau"} /* 13 */,
                                       _nrn_mechanism_field<double>{"Dm"} /* 14 */,
                                       _nrn_mechanism_field<double>{"Dh1"} /* 15 */,
                                       _nrn_mechanism_field<double>{"Dh2"} /* 16 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 Kv2like /Users/romanbaravalle/Documents/Consultancy/JaxleyPYRModel/.cache/neuron_optim_mod/Kv2like.mod\n");
...
static void _initlists(){
 ...
 _slist1[1] = {h1_columnindex, 0};  _dlist1[1] = {Dh1_columnindex, 0};
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/romanbaravalle/Documents/Consultancy/JaxleyPYRModel/.cache/neuron_optim_mod/Kv2like.mod";
