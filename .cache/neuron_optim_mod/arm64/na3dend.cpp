...
#define ar2 _ml->template fpfield<2>(_iml)
#define ar2_columnindex 2
...
#define zetas zetas_na3dend
 ...
 {"sinf_na3dend", "ms"},
 {"taus_na3dend", "ms"},
 {"fast_inactivation_tau_scale_na3dend", "mho/cm2"},
 {"ar2_na3dend", "1"},
 {0, 0}
};
...
"na3dend",
 "gbar_na3dend",
 "fast_inactivation_tau_scale_na3dend",
 "ar2_na3dend",
 0,
 0,
 "m_na3dend",
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"ar2"} /* 2 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 na3dend /Users/romanbaravalle/Documents/Consultancy/JaxleyPYRModel/.cache/neuron_optim_mod/na3dend.mod\n");
...
static int  trates (  double _lvm , double _la2 ) {
 ...
 _lqt = pow( q10 , ( ( celsius - 24.0 ) / 10.0 ) ) ;
   ...
   htau = htau * fast_inactivation_tau_scale ;
   if ( htau < hmin ) {
     htau = hmin ;
     }
...
static void _hoc_trates(void) {
  ...
  if(!_prop_id) {
    hoc_execerror("No data for trates_na3dend. Requires prior call to setdata_na3dend and that the specified mechanism instance still be in existence.", NULL);
  } else {
 ...
 v=_v;
{
 ...
 { error =  states();
 if(error){
  std_cerr_stream << "at line 69 in file na3dend.mod:\nBREAKPOINT {\n";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/romanbaravalle/Documents/Consultancy/JaxleyPYRModel/.cache/neuron_optim_mod/na3dend.mod";
  ...
  "	RANGE  gbar, fast_inactivation_tau_scale, ar2\n"
  "	GLOBAL minf, hinf, mtau, htau, sinf, taus,qinf, thinf\n"
  "}\n"
  "\n"
  "PARAMETER {\n"
  "	gbar = 0.010\n"
  "	fast_inactivation_tau_scale = 1   	(mho/cm2)	\n"
  "							\n"
