  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 4, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 12);
 	...
 	vhalfn = _parm_default[1]; /* 11 */
 	vhalfl = _parm_default[2]; /* -56 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 12);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"gka"} /* 4 */,
                                       _nrn_mechanism_field<double>{"n"} /* 5 */,
                                       _nrn_mechanism_field<double>{"l"} /* 6 */,
                                       _nrn_mechanism_field<double>{"ek"} /* 7 */,
                                       _nrn_mechanism_field<double>{"Dn"} /* 8 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 kap /Users/romanbaravalle/Documents/Consultancy/JaxleyPYRModel/.cache/neuron_optim_mod/kaprox.mod\n");
...
static void _hoc_alpn(void) {
  ...
  if(!_prop_id) {
    hoc_execerror("No data for alpn_kap. Requires prior call to setdata_kap and that the specified mechanism instance still be in existence.", NULL);
  } else {
...
static void _hoc_betn(void) {
  ...
  if(!_prop_id) {
    hoc_execerror("No data for betn_kap. Requires prior call to setdata_kap and that the specified mechanism instance still be in existence.", NULL);
  } else {
    _setdata(_extcall_prop);
  }
   _r =  betn (  *getarg(1) );
...
static void _hoc_alpl(void) {
  ...
  if(!_prop_id) {
    hoc_execerror("No data for alpl_kap. Requires prior call to setdata_kap and that the specified mechanism instance still be in existence.", NULL);
  } else {
    _setdata(_extcall_prop);
  }
   _r =  alpl (  *getarg(1) );
...
static void _hoc_betl(void) {
  ...
  if(!_prop_id) {
    hoc_execerror("No data for betl_kap. Requires prior call to setdata_kap and that the specified mechanism instance still be in existence.", NULL);
  } else {
    _setdata(_extcall_prop);
  }
   _r =  betl (  *getarg(1) );
...
static void _hoc_rates(void) {
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_kap. Requires prior call to setdata_kap and that the specified mechanism instance still be in existence.", NULL);
  } else {
    _setdata(_extcall_prop);
  }
   _r = 1.;
 ...
 v=_v;
{
 ...
 { error =  states();
 if(error){
  std_cerr_stream << "at line 63 in file kaprox.mod:\nBREAKPOINT {\n";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/romanbaravalle/Documents/Consultancy/JaxleyPYRModel/.cache/neuron_optim_mod/kaprox.mod";
